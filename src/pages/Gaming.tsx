    ...
    <Layout>
      <div className="max-w-7xl mx-auto py-6 px-4">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-foreground">Gaming</h1>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-foreground mb-2">No gaming videos yet</h2>
            <p className="text-muted-foreground">Gaming videos will appear here once uploaded</p>
          </div>
        )}
      </div>
    </Layout>
