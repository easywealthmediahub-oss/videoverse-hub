      ...
      <div className="max-w-7xl mx-auto py-6 px-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-foreground mb-2">No music videos yet</h2>
            <p className="text-muted-foreground">Music videos will appear here once uploaded</p>
          </div>
        )}
      </div>
    </Layout>
